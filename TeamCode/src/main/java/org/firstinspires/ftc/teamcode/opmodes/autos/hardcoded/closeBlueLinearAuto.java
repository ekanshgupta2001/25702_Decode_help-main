...
@Autonomous(name = "Linear Blue CLOSE Auto", group = "Linear")
public class closeBlueLinearAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // 2. Movement example
        setAllMotors(0.5);
        runWithUpdates(1050); // Drive forward for 900ms while updating prev (900)
        stopMotors();

        // 1. Start Shooter
        intake.spinIn();
        shooterSeq.start(ShooterManualSubsystem.ShooterState.LOW);
